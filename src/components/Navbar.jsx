...
export default function Navbar(){
  ...
  return (<>
    <div className='fixed top-0 left-0 w-screen flex justify-between items-center px-8 md:px-14 lg:px-40 py-2 h-20'>
    ...
    {mobileMenu && (
      <div className='absolute top-0 left-0 flex justify-center items-center h-full w-full bg-[#373A36]'>
        ...
        <div className='flex flex-col justify-between items-center space-y-8'>
          ...
          <Link onClick={() => { setMobileMenu(false) } } className='' to={'/overzicht'}>Overzicht</Link>
